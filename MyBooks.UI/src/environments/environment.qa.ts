export const environment = {
  ...
  catalogBaseUrl: 'https://qa.mybookcatalog.com/api/catalog',
  tenantBaseUrl: 'https://qa.mybookcatalog.com/api/tenant',
  authBaseUrl: 'https://qa.mybookcatalog.com/api/auth',
